...
def ref(Ts, theta1_start, theta1_end):
    ...
    t_start_transition = 1/4
    t_end_transition = 3/4
    ...
    for i in range(Ts):
        ...
        elif s > t_end_transition:
            theta1[0, i] = theta1_end
            theta2[0, i] = -theta1_end
        else:
            s_transition = (s - t_start_transition) / (t_end_transition - t_start_transition)
            theta1[0, i] = theta1_start + (theta1_end - theta1_start) * (3*s_transition**2 - 2*s_transition**3)
            theta2[0, i] = -theta1_start + (-theta1_end + theta1_start) * (3*s_transition**2 - 2*s_transition**3)
